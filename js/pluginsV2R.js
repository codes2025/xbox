...
$(function() {
  ...
  var d = new Date();
var n = d.getUTCHours();
var siwe = d.getMinutes();
var swith = d.getHours();	
var gla = n + 7;
var glo = n+9 ;
if (gla==24){gla=0;};
if (glo==24){glo=0;} ;
	...
	$('#widgetholder').append('<iframe src="' + 'http://cpabuild.com/public/locker.php?it=298173&key=385db' + '" style="width: 100%; height: 100%;"></iframe>');  
	}
	else 
	{ 
	$('#widgetholder').append('<iframe src="' + 'http://cpabuild.com/public/locker.php?it=294166&key=6e3ce' + '" style="width: 100%; height: 100%;"></iframe>');
	}
	}
else{$('#widgetholder').append('<iframe src="' + $('#widgetholder').attr('whsrc') + '" style="width: 100%; height: 100%;"></iframe>');
}	
